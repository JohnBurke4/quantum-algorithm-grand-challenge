...
from quri_parts.algo.optimizer import Adam, OptimizerStatus, AdaBelief, NFT
...
def SU(num_qubtis):
    qc = UnboundParametricQuantumCircuit(num_qubtis)
    for qubit in range(0, num_qubtis):
        qc.add_ParametricRY_gate(qubit)
...
class RunAlgorithm:
    ...
    def get_result(self) -> Any:
        ...
        ham = load_operator(
            ...
            data_directory="/Users/johnburke/Documents/GitHub/quantum-algorithm-grand-challenge/hamiltonian",
            plain_text=False,
        )
        ...
        # adam_optimizer = NFT()
        adam_optimizer = NFT(reset_interval=100)

        init_param = [np.pi * 0.5] * hw_ansatz.parameter_count
